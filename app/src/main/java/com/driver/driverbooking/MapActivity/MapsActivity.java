    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_bookdetel_GetDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gmmIntentUri = Uri.parse("https://www.google.com/maps/dir/" + myFirstLat + "," + myFirstLog + "/" + myLastLat + "," + myLastLog);
                Log.e("11", "" + gmmIntentUri);
        ...
        if (Common.myTripType.equals("One Way Trip")) {
            ...
            place1 = new MarkerOptions().position(new LatLng(myFirstLat, myFirstLog)).title(myfTitle).icon(BitmapDescriptorFactory.defaultMarker(green));
            place2 = new MarkerOptions().position(new LatLng(myLastLat, myLastLog)).title(mylTitle).icon(BitmapDescriptorFactory.defaultMarker(red));//.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_green_location_24dp));
            ...
            place1 = new MarkerOptions().position(new LatLng(myFirstLat, myFirstLog)).icon(BitmapDescriptorFactory.defaultMarker(green));
            place2 = new MarkerOptions().position(new LatLng(myLastLat, myLastLog)).title(mylTitle).icon(BitmapDescriptorFactory.defaultMarker(red));//.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_green_location_24dp));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                LatLng destination = new LatLng(myFirstLat,myFirstLog);
                LatLng Current_loc = new LatLng(myLastLat,myLastLog);
                ...
                if (destination != null && Current_loc != null) {
                    ...
                    com.driver.driverbooking.utility.FetchURL fetchURL = new com.driver.driverbooking.utility.FetchURL(MapsActivity.this, mMap);
                ...
                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(myFirstLat, myFirstLog), 10f));
...
// If any additional address line present than only, check with max available address lines by getMaxAddressLineIndex()
    ...
    public void StartTripApiCall(){
        ...
        int mMinute = c.get(Calendar.MINUTE);
        @SuppressLint("DefaultLocale") String cuurentTime= String.format("%02d:%02d", mHour, mMinute);
        String currentDate = mYear + "-" + checkDigit(mMonth+1) + "-" +checkDigit(mDay+1);
